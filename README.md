...
> **Hệ thống phần mềm máy tính (Desktop Application) dành cho việc quản lý toàn diện các hoạt động vận hành tại nhà thuốc tây: từ bán hàng, quản lý kho thuốc theo lô/hạn dùng, nhập hàng, quản lý đổi trả, đến báo cáo thống kê doanh thu và phân quyền nhân sự.**

---

## Giới thiệu dự án

Quản Lý Hiệu Thuốc Tây Mai Thức được thiết kế nhằm giải quyết bài toán quản lý thuốc tại các quầy thuốc và chuỗi bán lẻ dược phẩm. Hệ thống tự động hóa các quy trình từ nhập kho, phân loại thuốc theo danh mục, quản lý lô hạn dùng, xuất hóa đơn VAT, tích hợp chương trình khuyến mãi, đến quản lý đổi trả hàng và phân quyền bảo mật giữa Quản lý và Nhân viên bán hàng.

Giao diện người dùng được xây dựng với thư viện FlatLaf kết hợp đồ họa vector SVG, mang lại trải nghiệm mượt mà, trực quan và đáp ứng linh hoạt theo độ phân giải màn hình.
...
- **Xuất và in hóa đơn PDF:** Sử dụng thư viện iTextPDF để xuất hóa đơn bán hàng ra file PDF hoặc in trực tiếp.
...
- **Phân quyền người dùng (Role-Based Access Control):**
  ...
  - **Nhân viên bán thuốc:** Giới hạn nghiệp vụ bán lẻ, lập hóa đơn, tra cứu thuốc, xem thông tin khuyến mãi.
...
Hệ thống bao gồm hơn 17 thực thể có mối quan hệ chặt chẽ:
...
Mở file `src/ConnectDB/DatabaseConnection.java` và điều chỉnh thông tin tài khoản SQL Server:
```java
